    ...
    function validate_admin_login() {
		...
		if ($CI->session->userdata('isLogin') == 'yes') { 
					if($CI->session->userdata('user_type')==1){	
                        $url_segment= $CI->uri->segment(1);		
                        if($url_segment == 'publisher'){
                            redirect('/admin/dashboard','refresh');
                        }
                        else if($url_segment == 'advertiser'){
                            redirect('/admin/dashboard','refresh');
                        }		
                        ...
                        if($url_segment == 'admin'){
                            redirect('/publisher/campaign','refresh');
                        }
                        else if($url_segment == 'advertiser'){
                            redirect('/publisher/campaign','refresh');
                        }	
						//redirect('/publisher/campaign');		
					} else {	
                        $url_segment= $CI->uri->segment(1);
                        if($url_segment == 'admin'){
                            redirect('/advertiser/campaign','refresh');
                        }else if($url_segment == 'publisher'){
                            redirect('/advertiser/campaign','refresh');
                        }
